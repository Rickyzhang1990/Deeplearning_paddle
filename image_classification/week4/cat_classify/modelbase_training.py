...
# 定义优化方法
optimizer = fluid.optimizer.Adamax(learning_rate=1e-3)
...
src_pretrain_model_path = './pretrained_models/ResNet101_pretrained/ResNet101_pretrained/'
...
# 保存参数模型
save_pretrain_model_path = 'models/s1_8-16_model/'
# 删除旧的模型文件
